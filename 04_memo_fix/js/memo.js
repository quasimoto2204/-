    ...
    save.addEventListener("click", function (e) {
        ...
        if (key === "" || value === "") {
            Swal.fire({
                ...
                type: "error",
                allowOutsideClick: false,
                background: 'url(img/pepe1.png) center center / cover no-repeat',
            });
            return;
        } else {
            ...
            Swal.fire({
                ...
                background: 'url(img/93b.png) center center / cover no-repeat',
                ...
                if (result.value === true) {
                    ...
                    Swal.fire({
                        ...
                        background: 'url(img/pepe.png) center center / cover no-repeat',
    ...
    del.addEventListener("click", function (e) {
        ...
        if (w_cnt >= 1) {
            Swal.fire({
                ...
                background: 'url(img/monkas.png) center center / cover no-repeat',
            }).then(function (result) {
                if (result.value === true) {
                    for (let i = 0; i < chkbox1.length; i++) {
                        if (chkbox1[i].checked) {
